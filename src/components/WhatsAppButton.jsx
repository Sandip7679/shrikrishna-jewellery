...
const WhatsAppButton = ({
  phoneNumber = "919083163284", // ✅ Replace with your WhatsApp number (no + or spaces)
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-2 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg 
                 transition-all duration-300 hover:scale-110 z-10 flex items-center justify-center"
